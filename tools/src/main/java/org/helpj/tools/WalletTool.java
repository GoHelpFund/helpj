...
package org.helpj.tools;

import org.helpj.core.*;
import org.helpj.crypto.*;
import org.helpj.net.discovery.DnsDiscovery;
import org.helpj.params.MainNetParams;
import org.helpj.params.RegTestParams;
import org.helpj.params.TestNet3Params;
import org.helpj.protocols.payments.PaymentProtocol;
import org.helpj.protocols.payments.PaymentProtocolException;
import org.helpj.protocols.payments.PaymentSession;
import org.helpj.script.ScriptBuilder;
import org.helpj.store.*;
import org.helpj.uri.BitcoinURI;
import org.helpj.uri.BitcoinURIParseException;
import org.helpj.utils.BriefLogFormatter;
import org.helpj.wallet.DeterministicSeed;
import org.helpj.wallet.DeterministicUpgradeRequiredException;
import org.helpj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.helpj.core.listeners.BlocksDownloadedEventListener;
import org.helpj.core.listeners.DownloadProgressTracker;
import org.helpj.wallet.MarriedKeyChain;
import org.helpj.wallet.Protos;
import org.helpj.wallet.SendRequest;
import org.helpj.wallet.Wallet;
import org.helpj.wallet.WalletExtension;
import org.helpj.wallet.WalletProtobufSerializer;
import org.helpj.wallet.Wallet.BalanceType;
...
import static org.helpj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static org.helpcoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            ...
            try {
                paymentRequest = org.helpcoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {

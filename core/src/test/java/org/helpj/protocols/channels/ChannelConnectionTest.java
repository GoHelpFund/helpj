...
import static org.helpj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.helpj.testing.FakeTxBuilder.createFakeBlock;
import static org.helpcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.helpj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));

...
import static org.helpj.core.Coin.CENT;
import static org.helpj.core.Coin.COIN;
import static org.helpj.core.Coin.SATOSHI;
import static org.helpj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    public void standardCodes() throws Exception {
        assertEquals("HELP 0.00", MonetaryFormat.BTC.format(Coin.ZERO).toString());
        assertEquals("mHELP 0.00", MonetaryFormat.MBTC.format(Coin.ZERO).toString());
        assertEquals("µHELP 0", MonetaryFormat.UBTC.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dHELP 0", MonetaryFormat.UBTC.code(1, "dHELP").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        ...
        assertEquals("dHELP 0", MonetaryFormat.UBTC.noCode().code(1, "dHELP").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("HELP 0.00", MonetaryFormat.BTC.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 HELP", MonetaryFormat.BTC.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("HELP@0.00", MonetaryFormat.BTC.codeSeparator('@').format(Coin.ZERO).toString());
    }

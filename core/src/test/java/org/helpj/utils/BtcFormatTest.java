...
import static org.helpj.core.Coin.*;
import static org.helpj.core.NetworkParameters.MAX_MONEY;
import static org.helpj.utils.BtcAutoFormat.Style.CODE;
import static org.helpj.utils.BtcAutoFormat.Style.SYMBOL;
import static org.helpj.utils.BtcFixedFormat.REPEATING_DOUBLETS;
import static org.helpj.utils.BtcFixedFormat.REPEATING_TRIPLETS;
...
public class BtcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        // Coins
        assertEquals(valueOf(200000000), us.parseObject("HELP2"));
        ...
        assertEquals(valueOf(200000000), usCoded.parseObject("HELP 2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("HELP2.0"));
        ...
        assertEquals(valueOf(202222420000000L), us.parseObject("HELP2,022,224.20"));
        ...
        // MilliCoins
        assertEquals(valueOf(200000), usCoded.parseObject("mHELP 2"));
        ...
        assertEquals(valueOf(200000), us.parseObject("mHELP2"));
        ...
        assertEquals(valueOf(200000), usCoded.parseObject("₥HELP 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥XDC 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥HELP 2"));
        ...
        assertEquals(valueOf(202222400000L), us.parseObject("₥HELP2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("₥XDC2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("mHELP2,022,224"));
        ...
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥HELP 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥XDC 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mHELP 2,022,224"));
        ...
        assertEquals(valueOf(435), us.parseObject("uHELP4.35"));
        assertEquals(valueOf(435), us.parseObject("uXDC4.35"));
        assertEquals(valueOf(435), us.parseObject("µHELP4.35"));
        assertEquals(valueOf(435), us.parseObject("µXDC4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uHELP 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXDC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µHELP 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µXDC 4.35"));
        // fractional satoshi; round up
        assertEquals(valueOf(435), us.parseObject("uHELP4.345"));
        ...
        assertEquals(valueOf(-10), us.parseObject("(µHELP0.100)"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("HELP 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("HELP1.00"));
        ...
        // milli
        assertEquals(parseCoin("0.001"), cp.parseObject("mHELP 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mHELP1.00"));
        ...
        assertEquals(parseCoin("0.001"), cp.parseObject("₥HELP 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("₥HELP1.00"));
        ...
        // micro
        assertEquals(parseCoin("0.000001"), cp.parseObject("uHELP 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uHELP1.00"));
        ...
        assertEquals(parseCoin("0.000001"), cp.parseObject("µHELP 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("µHELP1.00"));
        ...
        // satoshi
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uHELP 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uHELP0.01"));
        ...
        assertEquals(parseCoin("0.00000001"), cp.parseObject("µHELP 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("µHELP0.01"));
        ...
        // cents
        assertEquals(parseCoin("0.01234567"), cp.parseObject("cHELP 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("cHELP1.234567"));
        ...
        assertEquals(parseCoin("0.01234567"), cp.parseObject("¢HELP 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("¢HELP1.234567"));
        ...
        // dekacoins
        assertEquals(parseCoin("12.34567"), cp.parseObject("daHELP 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daHELP1.234567"));
        ...
        // hectocoins
        assertEquals(parseCoin("123.4567"), cp.parseObject("hHELP 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hHELP1.234567"));
        ...
        // kilocoins
        assertEquals(parseCoin("1234.567"), cp.parseObject("kHELP 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kHELP1.234567"));
        ...
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MHELP 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MHELP1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        BtcFormat usCoded = BtcFormat.getCodeInstance(Locale.US);
        assertEquals("µHELP 0.01", usCoded.format(1));
        assertEquals("HELP 1.00", usCoded.format(COIN));

        /* Do not insert unneeded space BEFORE currency-code */
        BtcFormat frCoded = BtcFormat.getCodeInstance(Locale.FRANCE);
        assertEquals("0,01 µHELP", frCoded.format(1));
        assertEquals("1,00 HELP", frCoded.format(COIN));
        ...
        assertEquals("µHELP 0,01", deCoded.format(1));
        assertEquals("HELP 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("HELP 1", codedZero.format(COIN));
        assertEquals("µĐ1,000,000", symbolZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µHELP 1,000,000", codedZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µĐ1,000,000", symbolZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µHELP 1,000,000", codedZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µĐ999,999", symbolZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("µHELP 999,999", codedZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("Đ1,000", symbolZero.format(COIN.multiply(1000)));
        assertEquals("HELP 1,000", codedZero.format(COIN.multiply(1000)));
        assertEquals("µĐ1", symbolZero.format(Coin.valueOf(100)));
        assertEquals("µHELP 1", codedZero.format(Coin.valueOf(100)));
        assertEquals("µĐ1", symbolZero.format(Coin.valueOf(50)));
        assertEquals("µHELP 1", codedZero.format(Coin.valueOf(50)));
        assertEquals("µĐ0", symbolZero.format(Coin.valueOf(49)));
        assertEquals("µHELP 0", codedZero.format(Coin.valueOf(49)));
        assertEquals("µĐ0", symbolZero.format(Coin.valueOf(1)));
        assertEquals("µHELP 0", codedZero.format(Coin.valueOf(1)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(49999999)));
        assertEquals("µHELP 500,000", codedZero.format(Coin.valueOf(49999999)));

        assertEquals("µĐ499,500", symbolZero.format(Coin.valueOf(49950000)));
        assertEquals("µHELP 499,500", codedZero.format(Coin.valueOf(49950000)));
        assertEquals("µĐ499,500", symbolZero.format(Coin.valueOf(49949999)));
        assertEquals("µHELP 499,500", codedZero.format(Coin.valueOf(49949999)));
        assertEquals("µĐ500,490", symbolZero.format(Coin.valueOf(50049000)));
        assertEquals("µHELP 500,490", codedZero.format(Coin.valueOf(50049000)));
        assertEquals("µĐ500,490", symbolZero.format(Coin.valueOf(50049001)));
        assertEquals("µHELP 500,490", codedZero.format(Coin.valueOf(50049001)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(49999950)));
        assertEquals("µHELP 500,000", codedZero.format(Coin.valueOf(49999950)));
        assertEquals("µĐ499,999", symbolZero.format(Coin.valueOf(49999949)));
        assertEquals("µHELP 499,999", codedZero.format(Coin.valueOf(49999949)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(50000049)));
        assertEquals("µHELP 500,000", codedZero.format(Coin.valueOf(50000049)));
        assertEquals("µĐ500,001", symbolZero.format(Coin.valueOf(50000050)));
        assertEquals("µHELP 500,001", codedZero.format(Coin.valueOf(50000050)));
        ...
        assertEquals("HELP 1.00", codedTwo.format(COIN));
        assertEquals("µĐ999,999.99", symbolTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("µHELP 999,999.99", codedTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("Đ1,000.00", symbolTwo.format(COIN.multiply(1000)));
        assertEquals("HELP 1,000.00", codedTwo.format(COIN.multiply(1000)));
        assertEquals("µĐ1.00", symbolTwo.format(Coin.valueOf(100)));
        assertEquals("µHELP 1.00", codedTwo.format(Coin.valueOf(100)));
        assertEquals("µĐ0.50", symbolTwo.format(Coin.valueOf(50)));
        assertEquals("µHELP 0.50", codedTwo.format(Coin.valueOf(50)));
        assertEquals("µĐ0.49", symbolTwo.format(Coin.valueOf(49)));
        assertEquals("µHELP 0.49", codedTwo.format(Coin.valueOf(49)));
        assertEquals("µĐ0.01", symbolTwo.format(Coin.valueOf(1)));
        assertEquals("µHELP 0.01", codedTwo.format(Coin.valueOf(1)));
        ...
        assertEquals("HELP 1.000", codedThree.format(COIN));
        assertEquals("µĐ999,999.99", symbolThree.format(COIN.subtract(SATOSHI)));
        assertEquals("µHELP 999,999.99", codedThree.format(COIN.subtract(SATOSHI)));
        assertEquals("Đ1,000.000", symbolThree.format(COIN.multiply(1000)));
        assertEquals("HELP 1,000.000", codedThree.format(COIN.multiply(1000)));
        assertEquals("₥Đ0.001", symbolThree.format(Coin.valueOf(100)));
        assertEquals("mHELP 0.001", codedThree.format(Coin.valueOf(100)));
        assertEquals("µĐ0.50", symbolThree.format(Coin.valueOf(50)));
        assertEquals("µHELP 0.50", codedThree.format(Coin.valueOf(50)));
        assertEquals("µĐ0.49", symbolThree.format(Coin.valueOf(49)));
        assertEquals("µHELP 0.49", codedThree.format(Coin.valueOf(49)));
        assertEquals("µĐ0.01", symbolThree.format(Coin.valueOf(1)));
        assertEquals("µHELP 0.01", codedThree.format(Coin.valueOf(1)));
    }
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 HELP", BtcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("HELP -1,00", BtcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("Đ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("HELP -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("Đ-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(HELP 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        assertEquals("(Đ1.00)", BtcFormat.getSymbolInstance(US).format(COIN.multiply(-1)));
        // assertEquals("HELP -१.००", BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("HELP -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("HELP") && ! codePat.contains("(^|[^Đ])Đ([^Đ]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("Đ") && !symPat.contains("HELP") && !symPat.contains("¤¤"));

        assertEquals("HELP #,##0.00;(HELP #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format HELP #,##0.00;(HELP #,##0.00)", BtcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format HELP #,##0.0000;(HELP #,##0.0000)", BtcFormat.getCodeInstance(Locale.US, 4).toString());
        ...
        assertEquals("Auto-format HELP#,00Đ;HELP-#,00Đ",
                     BtcFormat.builder().style(SYMBOL).locale(GERMANY).pattern("¤¤#¤").build().toString());
        assertEquals("Coin-format HELP#,00Đ;HELP-#,00Đ",
                     BtcFormat.builder().scale(0).locale(GERMANY).pattern("¤¤#¤").build().toString());
        assertEquals("Millicoin-format HELP#.00Đ;HELP-#.00Đ",
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format HELP #.000;HELP -#.000", f.toString());
        assertEquals("mHELP 1000.000", f.format(COIN));
    }
    ...
    public void builderTest() {
        ...
        assertEquals("HELP -1,00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("¤¤##,###.#").scale(3).locale(US).build();
        assertEquals("mHELP1,000.00", built.format(COIN));
        built = BtcFormat.builder().pattern("¤ ##,###.#").scale(3).locale(US).build();

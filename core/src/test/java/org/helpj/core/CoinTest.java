...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 HELP", COIN.toFriendlyString());
        assertEquals("1.23 HELP", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 HELP", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 HELP", valueOf(1, 23).negate().toFriendlyString());
    }

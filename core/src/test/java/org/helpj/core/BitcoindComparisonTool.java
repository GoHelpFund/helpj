...
/**
 * A tool for comparing the blocks which are accepted/rejected by helpd/helpj
 * It is designed to run as a testnet-in-a-box network between a single helpd node and helpj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: helpjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");

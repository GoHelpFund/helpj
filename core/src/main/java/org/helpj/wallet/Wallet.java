...
import org.helpj.core.*;
import org.helpj.core.Message;
import org.helpj.core.listeners.*;
import org.helpj.core.TransactionConfidence.*;
import org.helpj.crypto.*;
import org.helpj.script.*;
import org.helpj.signers.*;
import org.helpj.utils.*;
import org.helpj.wallet.Protos.Wallet.*;
import org.helpj.wallet.WalletTransaction.*;
import org.helpj.wallet.listeners.KeyChainEventListener;
import org.helpj.wallet.listeners.ScriptsChangeEventListener;
import org.helpj.wallet.listeners.WalletChangeEventListener;
import org.helpj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.helpj.wallet.listeners.WalletCoinsSentEventListener;
import org.helpj.wallet.listeners.WalletEventListener;
import org.helpj.wallet.listeners.WalletReorganizeEventListener;
import org.helpj.core.InstantSend;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.helpj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.helpj.wallet.DeterministicKeyChain#ACCOUNT_ZERO_PATH 0 hardened path}
     */
     ...
     * {@link org.helpj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.helpj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.helpj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.helpj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.helpj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.helpj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.helpj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.helpj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.helpj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.helpj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.helpj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.helpj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.helpj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.helpj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.helpj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.helpj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.helpj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.helpj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.helpj.crypto.KeyCrypter,
     ...
     * {@link org.helpj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.helpj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.helpj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.helpj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.helpj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.helpj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */

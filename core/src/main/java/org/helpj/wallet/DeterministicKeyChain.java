...
import org.helpj.core.BloomFilter;
 ...
 * {@link org.helpj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.helpj.crypto.MnemonicCode},
 ...
 * {@link org.helpj.crypto.DeterministicKey#serializePubB58(org.helpj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.helpj.crypto.DeterministicKey#deserializeB58(org.helpj.crypto.DeterministicKey, String, org.helpj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.helpj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.helpj.crypto.DeterministicHierarchy} and
 * {@link org.helpj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    // m / 9' / 5' / 3' / 0' - 1000 HELP for masternode
     ...
     *  Using {@link org.helpj.crypto.KeyCrypter KeyCrypter} to decrypt.
     */
    protected DeterministicKeyChain(DeterministicSeed seed, @Nullable KeyCrypter crypter,
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.helpj.crypto.DeterministicKey)}
     ...
     * @see org.helpj.wallet.MarriedKeyChain
     */

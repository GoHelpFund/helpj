...
import static org.helpj.script.ScriptOpCodes.OP_RETURN;

import java.math.BigInteger;
import java.util.Date;

import org.helpcoin.protocols.payments.Protos.PaymentDetails;
...
import org.helpj.evolution.SubTxRegister;
import org.helpj.evolution.SubTxResetKey;
import org.helpj.evolution.SubTxTopup;
import org.helpj.script.Script;
import org.helpj.script.ScriptBuilder;
import org.helpj.script.ScriptChunk;
import org.helpj.utils.ExchangeRate;
import org.helpj.wallet.KeyChain.KeyPurpose;
import org.helpj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.helpj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.helpj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are

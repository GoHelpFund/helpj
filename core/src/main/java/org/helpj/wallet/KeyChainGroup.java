...
/**
 * <p>A KeyChainGroup is used by the {@link org.helpj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.helpj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.helpj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.helpj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */

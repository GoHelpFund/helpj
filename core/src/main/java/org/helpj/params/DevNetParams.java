...
/**
 * Parameters for a named devnet, a separate instance of Help that has relaxed rules suitable for development
 * and testing of applications and new Help versions.  The name of the devnet is used to generate the

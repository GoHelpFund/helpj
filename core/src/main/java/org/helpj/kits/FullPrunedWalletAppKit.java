 ...
 * Copyright 2019 Help Core Group
 *
...
import org.helpj.net.discovery.PeerDiscovery;
import org.helpj.protocols.channels.StoredPaymentChannelClientStates;
import org.helpj.protocols.channels.StoredPaymentChannelServerStates;
import org.helpj.store.*;
import org.helpj.wallet.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new full verification helpj app. Instantiate it with a directory
...
public class FullPrunedWalletAppKit extends AbstractIdleService {
    ...
    public FullPrunedWalletAppKit(Context context, File directory, String filePrefix) {
        ...
        context.initHelp(false, true);
        context.initHelpSync(directory.getAbsolutePath());
    }
    ...
    public FullPrunedWalletAppKit(Context context, File directory, String filePrefix, boolean liteMode) {
        ...
        context.initHelp(liteMode, true);
        context.initHelpSync(directory.getAbsolutePath());
    }
     ...
     * {@link org.helpj.core.listeners.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called

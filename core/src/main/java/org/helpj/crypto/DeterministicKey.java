...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link org.helpj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
     ...
     * in which case the time is stored alongside the key as per normal, see {@link org.helpj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override

...
import org.helpj.utils.BtcAutoFormat.Style;
import static org.helpj.utils.BtcAutoFormat.Style.*;
 ...
 * method.  This argument can be either a {@link org.helpj.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    private static final String COIN_CODE = "HELP";
    ...
    /**
      ...
      * {@link org.helpj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override

...
public abstract class DatabaseFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    /**
     * Create a new store for the given {@link org.helpj.core.NetworkParameters}.
     ...
     *
     * <p>The balance {@link org.helpj.store.DatabaseFullPrunedBlockStore#getBalanceSelectSQL()} returns

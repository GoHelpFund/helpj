...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/help-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/help-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/help-paymentack";

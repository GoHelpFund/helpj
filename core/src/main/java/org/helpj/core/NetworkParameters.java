...
import org.helpj.net.discovery.HttpDiscovery;
import org.helpj.params.*;
import org.helpj.quorums.LLMQParameters;
import org.helpj.script.Script;
import org.helpj.script.ScriptBuilder;
import org.helpj.script.ScriptOpCodes;
import org.helpj.store.BlockStore;
import org.helpj.store.BlockStoreException;
import org.helpj.utils.MonetaryFormat;
...
import org.helpj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_DEVNET = "org.aden.dev";
    /** Unit test network. */
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.helpj.net.discovery.HttpDiscovery} for more info. */
     ...
     *
     * <p>The second block in a devnet chain is a known constant shared between all Help DevNet implimentations for a
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.helpj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.helpj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.helpj.core.AlertMessage}s. You can use {@link org.helpj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */

...
import org.helpj.evolution.SimplifiedMasternodeListDiff;
import org.helpj.governance.GovernanceObject;
import org.helpj.governance.GovernanceSyncMessage;
import org.helpj.governance.GovernanceVote;
import org.helpj.governance.GovernanceVoteConfidence;
import org.helpj.net.StreamConnection;
import org.helpj.quorums.ChainLockSignature;
import org.helpj.quorums.InstantSendLock;
import org.helpj.store.BlockStore;
import org.helpj.store.BlockStoreException;
import org.helpj.utils.ListenerRegistration;
 ...
 * {@link org.helpj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.helpj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.helpj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.helpj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.helpj.core.TxConfidenceTable}
...
//            case MSG_DSTX:
  //              return mapDarksendBroadcastTxes.count(inv.hash);
     ...
     * Once the pong is received the value returned by {@link org.helpj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.helpj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.helpj.core.Peer#ping()} has never

...
import static org.helpj.core.Masternode.CollateralStatus.COLLATERAL_INVALID_AMOUNT;
import static org.helpj.core.Masternode.CollateralStatus.COLLATERAL_SPV_ASSUME_VALID;
import static org.helpj.core.Masternode.CollateralStatus.COLLATERAL_UTXO_NOT_FOUND;
import static org.helpj.core.MasternodeInfo.State.MASTERNODE_EXPIRED;
    ...
    boolean checkOutpoint(Dos nDos)
    {
...

        {
            ...
            if (err == COLLATERAL_INVALID_AMOUNT) {
                log.info("masternode--CMasternodeBroadcast::CheckOutpoint -- Masternode UTXO should have 1000 HELP, masternode={}", info.outpoint.toStringShort());
                return false;
            }
        ...
        // should be at least not earlier than block when 1000 HELP tx got nMasternodeMinimumConfirmations
        ...
        GetTransaction(vin.prevout.hash, tx2, Params().GetConsensus(), hashBlock, true);
        {
            ...
            if (mi != mapBlockIndex.end() && (*mi).second) {
                CBlockIndex* pMNIndex = (*mi).second; // block for 1000 HELP tx -> 1 confirmation

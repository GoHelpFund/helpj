...
import org.helpcoin.NativeSecp256k1;
import org.helpcoin.NativeSecp256k1Util;
import org.helpcoin.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.helpj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.helpj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.helpj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * @throws org.helpj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link org.helpj.core.DumpedPrivateKey#toString()} method to get the string.
     *

...
import org.helpj.governance.GovernanceVote;
import org.helpj.governance.GovernanceVoteBroadcast;
import org.helpj.governance.GovernanceVoteBroadcaster;
import org.helpj.governance.GovernanceVoteConfidence;
import org.helpj.net.*;
import org.helpj.net.discovery.*;
import org.helpj.script.*;
import org.helpj.utils.*;
import org.helpj.utils.Threading;
...
public class PeerGroup implements TransactionBroadcaster, GovernanceVoteBroadcaster {
    ...
    public ReentrantLock getLock() { return lock; }  //for help
     ...
     * {@link org.helpj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.helpj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.helpj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.helpj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.helpj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.helpj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.helpj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.helpj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.helpj.core.Peer#ping()}.
     */

...
import org.helpj.utils.ContextPropagatingThreadFactory;
...
import static org.helpj.core.MasternodeManager.MASTERNODES_DUMP_SECONDS;
...
public class DarkSendPool {
    ...
    public boolean startBackgroundProcessing()
    {
        if(backgroundThread == null)
        {
            ...
            backgroundThread = new ContextPropagatingThreadFactory("help-privatesend").newThread(threadCheckDarkSendPool);

...
public class CoinDefinition {
    ...
    public static final String coinName = "Help";
    public static final String coinTicker = "HELP";
    public static final String coinURIScheme = "help";
    ...
    public static final String UNSPENT_API_URL = "https://chainz.cryptoid.info/help/api.dws?q=unspent";
    ...
    public static final String BLOCKEXPLORER_BASE_URL_PROD = "http://explorer.gohelpfund.com/";    //blockr.io
    public static final String BLOCKEXPLORER_ADDRESS_PATH = "address/";             //blockr.io path
    public static final String BLOCKEXPLORER_TRANSACTION_PATH = "tx/";              //blockr.io path
    public static final String BLOCKEXPLORER_BLOCK_PATH = "block/";                 //blockr.io path
    public static final String BLOCKEXPLORER_BASE_URL_TEST = "http://test.explorer.gohelpfund.com/";

    public static final String DONATION_ADDRESS = "Xdeh9YTLNtci5zSL4DDayRSVTLf299n9jv";  //Hash Engineering donation HELP address
    ...
    public static final long INSTANTX_FEE = 100000; //0.001 HELP (updated for 12.1)
    ...
    static public String[] dnsSeeds = new String[] {
            "dnsseed.gohelpfund.com",
            "dnsseed.helpdot.io",
            "dnsseed.helpmasternode.io",
    };
    ...
    static public String[] testnetDnsSeeds = new String[] {
            "testnet-seed.helpdot.io",
            "test.dnsseed.helpmasternode.io",
    };

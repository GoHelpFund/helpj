...
import org.helpj.crypto.BLSSignature;
import org.helpj.evolution.SimplifiedMasternodeList;
import org.helpj.evolution.SimplifiedMasternodeListEntry;
...
import static org.helpj.core.InstantSend.INSTANTSEND_TIMEOUT_SECONDS;
...
public class TransactionLockVote extends Message implements Serializable {
    ...
    public boolean isValid(Peer peer)
    {
        ...
        if(params.isSupportingEvolution() && masternodeListManager.isDeterministicMNsSporkActive()) {
            ...
            // At this point Help Core would check unspent outputs (UTXO's) to find the

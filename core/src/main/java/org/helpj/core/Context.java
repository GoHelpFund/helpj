...
import org.helpj.core.listeners.BlockChainListener;
import org.helpj.core.listeners.NewBestBlockListener;
import org.helpj.evolution.EvolutionUserManager;
import org.helpj.evolution.SimplifiedMasternodeListManager;
import org.helpj.governance.GovernanceManager;
import org.helpj.governance.GovernanceTriggerManager;
import org.helpj.governance.VoteConfidenceTable;
import org.helpj.quorums.*;
import org.helpj.store.FlatDB;
import org.helpj.store.HashStore;
import org.helpj.bls.BLS;
import org.slf4j.*;
...
public class Context {
    ...
    /**
     * Require that new threads use {@link #propagate(Context)} or {@link org.helpj.utils.ContextPropagatingThreadFactory},
     ...
     * a {@link org.helpj.utils.ContextPropagatingThreadFactory}.
     */
    ...
    /**
     * Returns the {@link org.helpj.core.NetworkParameters} specified when this context was (auto) created. The
    ...
    // Help Specific
    //
    private boolean initializedHelp = false;

    public boolean isInitializedHelp() {
        return initializedHelp;
    }

    public void initHelp(boolean liteMode, boolean allowInstantX) {
        initHelp(liteMode, allowInstantX, null);
    }

    public void initHelp(boolean liteMode, boolean allowInstantX, @Nullable EnumSet<MasternodeSync.SYNC_FLAGS> syncFlags) {
        initHelp(liteMode, allowInstantX, syncFlags, null);
    }
    public void initHelp(boolean liteMode, boolean allowInstantX, @Nullable EnumSet<MasternodeSync.SYNC_FLAGS> syncFlags,
    ...
    public void closeHelp() {
        ...
        initializedHelp = false;
        governanceManager = null;
    }

    public void initHelpSync(final String directory)
    {

...
public class Utils {
    ...
    public static org.helpj.utils.Pair<Integer, String> splitHostPort(String in) {
        ...
        return new org.helpj.utils.Pair<Integer, String>(port, host);
    }
